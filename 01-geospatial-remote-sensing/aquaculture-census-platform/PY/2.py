...
if __name__ == "__main__":
    datapath = r'E:\全省养殖池溏上图入库普查\养殖信息统计\20250818\疑点'
    prefixlktable = r'E:\全省养殖池溏上图入库普查\填报进度统计\江苏省城市缩写-调格式.xlsx'  # 图斑编号前缀查找表
    xlsfile = '六合区.xlsx'
    polygon_file = r'E:\全省养殖池溏上图入库普查\养殖信息统计\20250818\20250818池塘图斑.gpkg'
    ...
    #
    #
    # outfile =r'E:\全省养殖池溏上图入库普查\PY\七鱼疑点\无锡市\无锡市-疑点.xlsx'
