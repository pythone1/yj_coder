...
def ref2RGB(reffile,RGBfile,stretch_mode):
...
if __name__ == '__main__':
    reffile = r'I:\pyMethod\segment-anything\SAM_paddle_landclassify\s2_moel\nanjingclss_2022-04-18.tif'
    RGBfile = r'I:\pyMethod\segment-anything\SAM_paddle_landclassify\s2_moel\test\nanjingclss_2022-04-18.tif'
    stretch_mode = '1%'

    ref2RGB(reffile, RGBfile, stretch_mode)
    # rgbinfo = geotiffread (r'I:\paddlex_data\rawData\landClassify_nanjing_20201020\img\caijian\1.tif')
    # refinfo = geotiffread (r'I:\paddlex_data\rawData\landClassify_nanjing_20201020\img\caijian\2.tif')
    # rgbdataarray = rgbinfo.dataarray
    # refdataarray = refinfo.dataarray
    # rgbnirdataarray = np.zeros((rgbdataarray.shape[0], rgbdataarray.shape[1], 4))
    # rgbnirdataarray[:,:,0] = rgbdataarray[:,:,0]
    # rgbnirdataarray[:,:,1] = rgbdataarray[:,:,1]
    # rgbnirdataarray[:,:,2] = rgbdataarray[:,:,2]
    # rgbnirdataarray[:,:,3] = refdataarray[:,:,3]


    #转RGB
    # refpath = r'I:\最终结果汇总\无人机三期\YUANSHI'
    # rgbpath = r'I:\最终结果汇总\无人机三期\RGB'
    # os.chdir(refpath)
    ...
    # jpgpath= r'I:\paikou\JPEGImages'
    # tifpath= r'I:\paikou\tif'
    # jpg_t_tif(jpgpath,tifpath)

    # tifpath = r'I:\paddlex_data\SHP&SLICE\zb1'
    # tif_list = glob.glob(tifpath + '\\' + '*.tif')
    # for tif in tif_list:
    #     tifdata = geotiffread(tif)
    #     pixelnum=512
    #     outpath=r'I:\paddlex_data\SHP&SLICE\zb1\zb_jpg'
    #     imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="zb", suffix=".jpg", datatype="UINT8")

    # tifpath = r'G:\Sentinel_DATA\nj10\RGB'
    # outpath= r'G:\Sentinel_DATA\nj10\RGB\slice'
    # pixelnum=512
    #
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".tif", datatype="UINT8")

    # tifpath = r'I:\长江无人机\11月北岸\tif'
    # outpath= r'I:\长江无人机\11月北岸\slice'
    # pixelnum=512
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".jpg", datatype="UINT8")

    # tifpath = r'I:\长江无人机\长江南京段无人机影像\10月北岸\tif'
    # outpath= r'I:\长江无人机\长江南京段无人机影像\10月北岸\slice'
    # pixelnum=512
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".jpg", datatype="UINT8")

    # tifpath = r'I:\长江无人机\长江南京段无人机影像\10月南岸\tif'
    # outpath= r'I:\长江无人机\长江南京段无人机影像\10月南岸\slice'
    # pixelnum=512
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".jpg", datatype="UINT8")


    # tifpath = r'K:\赣榆未裁剪无人机\tif'
    # outpath= r'K:\赣榆未裁剪无人机\slice\JPEGImages'
    # pixelnum=512
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".jpg", datatype="UINT8")

    # tifpath = r'I:\长江无人机\长江南京段无人机影像\202002洲岛\tif'
    # outpath= r'I:\长江无人机\长江南京段无人机影像\202002洲岛\slice'
    # pixelnum=512
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".jpg", datatype="UINT8")

    # tifpath = r'I:\长江无人机\长江南京段无人机影像\202002洲岛\lvshuiwan'
    # outpath= r'I:\长江无人机\长江南京段无人机影像\20c2002洲岛\slice_lv'
    # pixelnum=512
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".jpg", datatype="UINT8")
    #
    #
    # tifpath = r'I:\长江无人机\长江南京段无人机影像\202003胥河大桥八卦洲\tif'
    # outpath= r'I:\长江无人机\长江南京段无人机影像\202003胥河大桥八卦洲\slice'
    # pixelnum=512
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".jpg", datatype="UINT8")

    # tifpath = r'I:\长江无人机\长江南京段无人机影像\202005绿水湾\tif'
    # outpath= r'I:\长江无人机\长江南京段无人机影像\202005绿水湾\slice'
    # pixelnum=512
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".jpg", datatype="UINT8")
    ...
    # tifpath = r'I:\长江无人机'
    # outpath= r'I:\paikou\tif'c
    # pixelnum=512
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".tif", datatype="UINT8")


    # tifpath = r'I:\downloads\slice'
    # outpath= r'I:\downloads\1'
    # pixelnum=2048
    # imgslice_by_pixels(tifpath, pixelnum, outpath, prefix="", suffix=".jpg", datatype="UINT8")



    # imgslice_by_rowcol(tifdata, rownum, colnum, outpath, prefix="000", suffix=".jpg", datatype="UINT8")
    #
    #
    # imgslice_by_pixels(tifdata, pixelnum, outpath, prefix="000", suffix=".tif", datatype="UINT8")
    # imgslice_by_rowcol(tifdata, rownum, colnum, outpath, prefix="000", suffix=".jpg", datatype="UINT8")
