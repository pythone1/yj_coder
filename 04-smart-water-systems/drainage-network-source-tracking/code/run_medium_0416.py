...
模块说明: run_medium_0416.py - 核心业务算法实现
...
def main() -> None:
    ...
    config = ExperimentConfig(
        ...
        initial_ppd_keep_fraction=0.65,
        initial_ppd_min_count=90,
        ...
        posterior_validation_samples=36,
        parallel_workers=8,
    ...
    log_progress("0520 medium run ready")
