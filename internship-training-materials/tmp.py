...
datapath = r'D:\图斑校核\宿豫二次校核'
outpath = r'D:\图斑校核\宿豫二次校核'
basename = '宿豫区d5m_x0_x130300'
...
gdf = pd.concat(glist)
gdf['area'] = gdf.geometry.area
gdf = filterNms(gdf, scfield='area', threshold=0.7)
gdf.to_file(f'{outpath}\\{basename}_人工校核1_人工校核2.shp') 
