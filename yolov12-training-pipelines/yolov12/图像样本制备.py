...
if __name__ == '__main__':
    tiffile = r'F:\水产种质资源保护区\卫星影像.tif'
    shpfile = r'F:\水产种质资源保护区\保护区三地类.gpkg'
    outpath = r'F:\data\sample'
    getTrainingSet1(tiffile, shpfile, outpath, imgsize=1024, labelfield='lx')