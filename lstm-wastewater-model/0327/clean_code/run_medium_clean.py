...
OUTPUT_DIR = RESULT_DIR / "clean_medium_run"
...
def main() -> None:
    ...
    log_progress("Starting medium run (~target 10-12 hours depending on machine and SWMM runtime)")
    ...
    summary = {
        "run_mode": "0327 clean medium run",
    ...
    log_progress("Medium run finished")
