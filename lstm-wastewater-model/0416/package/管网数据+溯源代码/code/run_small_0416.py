...
def main() -> None:
    ...
    save_json(truth_check, SMALL_RESULT_DIR / "0417_truth_replay_check.json")
    ...
    save_json(summary, SMALL_RESULT_DIR / "0417_summary.json")
    log_progress("0416 small run ready")
