...
if __name__ == '__main__':
    ...
    datapath = r'E:\江苏省养殖池塘上图入库项目\质控检查\0417苏北'
    ...
    polygon_file = r'E:\江苏省养殖池塘上图入库项目\质控检查\0417苏北\江苏省图斑0417.gpkg'
    yzpz_file=r'E:\江苏省养殖池塘上图入库项目\质控检查\新增亩产量疑点核查\养殖种类-江苏.xlsx'
    xlsfile = '泰州市.xlsx'
