const knowledgeRadar = [
    ...
    },
    {
        ...
        "actions": [
            "补 TimesFM/Chronos/TimeGPT 对比卡",
            "用水质数据做零样本预测实验",
            "比较 LSTM 与 foundation model 的 MAE/稳定性"
        ],
        "interview": "时序基础模型的价值是把跨行业时序模式预训练成通用表征，再用少量本地数据适配水质、能耗、药剂和负荷预测。",
        "sources": [
            {
                "label": "Google TimesFM GitHub",
                "url": "https://github.com/google-research/timesfm"
            },
            {
                "label": "Amazon Chronos GitHub",
                "url": "https://github.com/amazon-science/chronos-forecasting"
            },
            {
                "label": "Nixtla TimeGPT docs",
                "url": "https://docs.nixtla.io/"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "sources": [
            {
                "label": "NeuralOperator docs",
                "url": "https://neuraloperator.github.io/dev/"
            },
            {
                "label": "NVIDIA PhysicsNeMo docs",
    ...
    },
    {
        ...
        "sources": [
            {
                "label": "Evidently data drift docs",
    ...
    },
    {
        ...
        "sources": [
            {
                "label": "PyTorch Geometric Temporal",
                "url": "https://pytorch-geometric-temporal.readthedocs.io/"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "actions": [
            "给 RAG 文档设计 metadata 字段",
            "补向量检索过滤概念卡",
            "规划 Qdrant/Milvus 对比表"
        ],
    ...
    },
    {
        ...
        "sources": [
            {
                "label": "Milvus hybrid search docs",
                "url": "https://milvus.io/docs/hybrid_search_with_milvus.md"
            }
        ]
    },
    {
        ...
        "sources": [
            {
                "label": "Weaviate named vectors",
                "url": "https://docs.weaviate.io/weaviate/config-refs/schema/multi-vector"
            }
        ]
    },
    {
        ...
        "actions": [
            "把求职材料处理设计成 graph workflow",
            "补 human-in-the-loop 节点",
            "记录每步状态和失败恢复策略"
        ],
