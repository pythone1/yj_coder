...
in_path = r"F:\20251027宜兴市养殖水域滩涂规划修编\数据\三区划定\限养区.shp"
out_path = r"F:\20251027宜兴市养殖水域滩涂规划修编\过程数据\新建镇养殖区\去重叠\限养区.gpkg"
# 优先级映射（数值越大表示优先级越高/更重要）
priority_map = {"2-5": 5, "2-1": 4, "2-2": 3, "2-3": 2, "2-4": 1,}
...
# -----------------------
# 确保必要字段存在
for c in ["overlap","orig_index", "orig_seq", "from_overlap", "新序号", "删除", "规划面积（公顷）", "经度", "纬度"]:
...
final_cols = out_cols + ["overlap","orig_seq", "from_overlap", "新序号", "删除", "规划面积（公顷）", "经度", "纬度", "geometry"]
