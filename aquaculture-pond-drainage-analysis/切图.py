    ...
    for i in range(0, rows, step):
        for j in range(0, cols, step):
            ...
            if c_label.size !=0 and c_data.size !=0:
                print(1)
                # if data_label.shape==(1024, 1024 , 1):
                ...
                # if geotiff.bands == 3:
                    c_geotrans = (geo_transform[0] + j * geo_transform[1], geo_transform[1], geo_transform[2],
                                  geo_transform[3] + i * geo_transform[5], geo_transform[4], geo_transform[5])
                # 标签制作
                    print(os.path.join(anno_path, filename + ".tif"))
...
if __name__ == '__main__':
    tiffile = r'E:\水产种质资源保护区\2.tif'
    shpfile = r'E:\水产种质资源保护区\1.shp'
    outpath = r'E:\水产种质资源保护区\data'
    getTrainingSet1(tiffile, shpfile, outpath, imgsize=2048, labelfield='type')