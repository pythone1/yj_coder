...
in_path = r"F:\20251027宜兴市养殖水域滩涂规划修编\数据\三区划定\养殖区.shp"
out_path = r"F:\20251027宜兴市养殖水域滩涂规划修编\过程数据\新建镇养殖区\去重叠\养殖区.gpkg"
...
print("说明：")
print(
	" - 字段说明：orig_index(原要素id)、orig_seq(原序号)、from_overlap(1=交集块,0=余下部分)、新序号、删除(1=建议删除)、规划面积（公顷）、经度、纬度。")
