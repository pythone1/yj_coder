...
def 生成监测点重构建议图() -> Path:
    ...
    return 生成指定方案结构图(
        proposal,
        output_name="0327_监测点重构建议.html",
        title="0327 监测点重构建议（先确认布局，再回写主实验）",
        summary_title="0327 监测点重构建议",
...
def 生成主干连续20点建议图() -> Path:
    ...
    return 生成指定方案结构图(
        proposal,
        output_name="0327_主干连续20点建议.html",
        title="0327 连续主干 20 点重构建议（先确认结构，再回写配置）",
        summary_title="0327 连续主干 20 点建议",
        extra_lines=extra_lines,
    )
...
def 生成全局分散20点建议图() -> Path:
    ...
    return 生成指定方案结构图(
        proposal,
        output_name="0327_全局分散20点建议.html",
        title="0327 全局分散主干 20 点建议（先确认结构，再回写配置）",
        summary_title="0327 全局分散主干 20 点建议",
        extra_lines=extra_lines,
    )
...
def 生成结构审计后全局建议图() -> Path:
    ...
    return 生成指定方案结构图(
        proposal,
        output_name="0327_结构审计后全局建议.html",
        title="0327 结构审计后全局选点建议（先确认，再回写主实验）",
        summary_title="0327 结构审计后全局选点建议",
        extra_lines=extra_lines,
    )
...
def 生成深度审计后走廊建议图() -> Path:
    ...
    return 生成指定方案结构图(
        proposal,
        output_name="0327_深度审计后走廊建议.html",
        title="0327 深度审计后连续走廊建议（先确认，再回写主实验）",
        summary_title="0327 深度审计后连续走廊建议",
        extra_lines=extra_lines,
    )
...
def 生成加密监测布设建议图() -> Path:
    ...
    return 生成指定方案结构图(
        proposal,
        output_name="0327_加密监测布设建议.html",
        title="0327 加密监测布设建议（先确认，再回写主实验）",
        summary_title="0327 加密监测布设建议",
        extra_lines=extra_lines,
    )
